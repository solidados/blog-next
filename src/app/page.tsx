      ...
      <div className="container mx-auto p-4 relative">
        <div className="bg-white border-2 border-purple-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-center">
            ...
            <Link
              href={"/blog/posts"}
              className={`outline outline-1 outline-offset-2 border-purple-700 hover:text-white py-2 px-4 mb-2 rounded hover:bg-purple-800 md:w-auto ${styles.text_wisteria} ${styles.fit_content}`}
            >
              Go to Blog
            </Link>
          </div>
